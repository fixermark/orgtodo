...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "sfs5m16cjy4rxeqe3vfvqef4397szm5k6yxkmrj391u4sprpk6fh",
  ...
  manifest = (
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "tasklist"),
        command = .myCommand
  ...
  alwaysInclude = ["opt/app/node_modules", "usr/lib/node_modules", "opt/app/build/db/Migrate.js"],
